...
-- ============================================================
-- EXTRA 2: student_posts เพิ่มเติม (post_id 24–43)
-- ใช้ student_id 1–5 (active) วิชาหลากหลาย ทั้ง open และ closed
-- (post_id 19–23, app_id 21–25, payment_id 17–21, review_id 13–17 ถูกใช้ใน EXTRA bad reviews แล้ว)
-- ============================================================
INSERT INTO student_posts (post_id, student_id, subject, grade_level, learning_format, location, preferred_time, description, budget, status) VALUES
-- Open posts — ติวเตอร์ยังสมัครได้
(24, 1, 'คณิตศาสตร์',   'ม.4',    'online',  'ออนไลน์',              'จันทร์-พุธ 18:00-20:00',     'ติว PAT1 เน้นตะลุยโจทย์ระดับยาก อยากได้คะแนน 200+',                       1200.00, 'open'),
(25, 2, 'ภาษาอังกฤษ',   'ม.6',    'online',  'ออนไลน์',              'เสาร์ 09:00-12:00',          'ติว IELTS เน้น Writing Band 7+ ต้องการสมัคร ป.โท ต่างประเทศ',              2500.00, 'open'),
(26, 3, 'ฟิสิกส์',       'ม.3',    'onsite',  'บางนา กรุงเทพฯ',      'อาทิตย์ 10:00-12:00',        'ปูพื้นฐานกลศาสตร์ แรง และการเคลื่อนที่ เตรียมขึ้น ม.4',                   800.00,  'open'),
(27, 4, 'ภาษาจีน',       'ม.5',    'online',  'ออนไลน์',              'อังคาร พฤหัส 20:00-21:30',   'ต้องการเรียน HSK 4 เน้น grammar และ speaking เพื่อใช้งานจริง',              1500.00, 'open'),
(28, 5, 'ชีววิทยา',      'ม.6',    'both',    'เชียงใหม่ / ออนไลน์', 'จันทร์-ศุกร์ 07:00-08:00',   'ติว A-Level ชีวะ เน้นระบบร่างกายมนุษย์และพันธุศาสตร์',                     2000.00, 'open'),
(29, 1, 'สถิติ',          'ม.4',    'online',  'ออนไลน์',              'พุธ ศุกร์ 17:30-19:00',      'เรียนสถิติพื้นฐาน ความน่าจะเป็น การแจกแจง เพื่อสอบกลางภาค',               900.00,  'open'),
(30, 2, 'เคมี',           'ม.6',    'online',  'ออนไลน์',              'ทุกวัน 06:30-07:30',         'ติว A-Level เคมี กรด-เบส สมดุล ปฏิกิริยาออกซิเดชัน เร่งด่วน',              1800.00, 'open'),
(31, 3, 'ภาษาไทย',       'ม.3',    'onsite',  'ลาดกระบัง กรุงเทพฯ',  'เสาร์-อาทิตย์ 13:00-15:00', 'อยากเขียนเรียงความได้ดีขึ้น ฝึกอ่านจับใจความ เตรียมสอบปลายปี',             600.00,  'open'),
(32, 4, 'สังคมศึกษา',    'ม.5',    'online',  'ออนไลน์',              'เสาร์ 14:00-16:00',          'ติวประวัติศาสตร์ไทย ภูมิศาสตร์ เตรียมสอบ O-NET และ A-Level',               700.00,  'open'),
(33, 5, 'ภาษาอังกฤษ',   'ม.6',    'both',    'กรุงเทพฯ / ออนไลน์',  'อาทิตย์ 09:00-12:00',        'ต้องการเพิ่ม TOEIC ให้ได้ 750+ สมัครงานหลังเรียนจบ',                        2000.00, 'open'),
(34, 1, 'ฟิสิกส์',       'ม.4',    'online',  'ออนไลน์',              'พฤหัส เสาร์ 18:00-20:00',    'ติวฟิสิกส์พื้นฐาน คลื่น แสง เสียง เตรียมสอบกลางภาคเทอม 2',               1000.00, 'open'),
(35, 2, 'คณิตศาสตร์',   'ม.6',    'onsite',  'อ่อนนุช กรุงเทพฯ',    'เสาร์ 10:00-12:00',          'แคลคูลัส limit derivative integral เตรียมสอบเข้ามหาลัย',                    1200.00, 'open'),
(36, 3, 'ภาษาอังกฤษ',   'ม.3',    'online',  'ออนไลน์',              'จันทร์ พุธ ศุกร์ 17:00-18:00','ปูพื้นฐาน grammar และ vocabulary เตรียมเข้า ม.4',                            700.00,  'open'),
(37, 4, 'ฟิสิกส์',       'ม.5',    'online',  'ออนไลน์',              'อังคาร พฤหัส 19:00-21:00',   'ไฟฟ้ากระแสตรง ไฟฟ้ากระแสสลับ แม่เหล็กไฟฟ้า ติวเจาะข้อสอบ',               1500.00, 'open'),
(38, 5, 'คณิตศาสตร์',   'ม.6',    'online',  'ออนไลน์',              'จันทร์-ศุกร์ 20:00-21:30',   'สถิติและความน่าจะเป็น ระดับมหาลัย ใช้ Excel ประกอบการสอน',                 1800.00, 'open'),
-- Closed posts — จบแล้ว ใช้เป็น reference สำหรับ transaction_logs ชุดใหม่
(39, 1, 'ภาษาจีน',       'ม.4',    'online',  'ออนไลน์',              'เสาร์ 10:00-12:00',          'เริ่มต้นเรียนภาษาจีนจากศูนย์ ออกเสียงวรรณยุกต์ และพินอิน',                 1200.00, 'closed'),
(40, 2, 'ชีววิทยา',      'ม.6',    'online',  'ออนไลน์',              'พุธ ศุกร์ 18:00-20:00',      'ระบบภูมิคุ้มกัน ฮอร์โมน ประสาท เตรียม A-Level',                            2000.00, 'closed'),
(41, 3, 'เคมี',           'ม.3',    'onsite',  'รามคำแหง กรุงเทพฯ',   'อาทิตย์ 10:00-12:00',        'อะตอมและตารางธาตุ พันธะเคมีพื้นฐาน เตรียมขึ้น ม.4',                        800.00,  'closed'),
(42, 4, 'คณิตศาสตร์',   'ม.5',    'online',  'ออนไลน์',              'เสาร์-อาทิตย์ 08:00-10:00',  'ฟังก์ชันตรีโกณมิติ เอกซ์โพเนนเชียล ลอการิทึม เตรียมสอบ',                 1000.00, 'closed'),
(43, 5, 'ภาษาอังกฤษ',   'ม.6',    'online',  'ออนไลน์',              'จันทร์-ศุกร์ 06:30-07:30',   'Grammar intensive + reading comprehension เตรียม ONET',                     1500.00, 'closed');

-- Applications สำหรับ post 39–43 (completed)
INSERT INTO applications (app_id, post_id, tutor_id, status, applied_at, teaching_status) VALUES
(26, 39, 4, 'accepted', '2026-03-01 09:00:00', 'completed'),  -- สมชาย + จิตรา ภาษาจีน
(27, 40, 5, 'accepted', '2026-03-03 10:00:00', 'completed'),  -- สมหญิง + ระพี ชีวะ
(28, 41, 3, 'accepted', '2026-03-05 11:00:00', 'completed'),  -- มะลิ + อาร์ท เคมี
(29, 42, 1, 'accepted', '2026-03-07 09:00:00', 'completed'),  -- ปราณี + มานี คณิต
(30, 43, 2, 'accepted', '2026-03-09 06:30:00', 'completed');  -- ธนภัทร + ชูใจ อังกฤษ

-- Payments สำหรับ app 26–30
INSERT INTO payments (payment_id, app_id, amount, platform_fee, status) VALUES
(22, 26, 1200.00, 120.00, 'completed'),
(23, 27, 2000.00, 200.00, 'completed'),
(24, 28,  800.00,  80.00, 'completed'),
(25, 29, 1000.00, 100.00, 'completed'),
(26, 30, 1500.00, 150.00, 'completed');

-- Reviews สำหรับ app 26–30
INSERT INTO reviews (review_id, app_id, rating, comment, created_at) VALUES
(18, 26, 4, 'ครูจิตราสอนจีนได้ดีมากค่ะ ระบบเสียงวรรณยุกต์ยากมากแต่ครูสอนอธิบายชัด ตอนนี้พูดได้แล้วค่ะ', '2026-03-20 20:00:00'),
(19, 27, 5, 'ครูระพีสอนชีวะเข้าใจง่ายมากครับ ระบบภูมิคุ้มกันที่เคยงงมาก พอเรียนกับครูแล้วเคลียร์เลย', '2026-03-22 19:30:00'),
(20, 28, 5, 'ครูอาร์ทสอนเคมีได้ดีเลยค่ะ อะตอมและพันธะที่คิดว่ายากมาก กลายเป็นเรื่องง่ายไปเลย ขอบคุณมากค่ะ', '2026-03-24 18:00:00'),
(21, 29, 4, 'ครูมานีสอนตรีโกณมิติได้ชัดเจนครับ มีตัวอย่างเยอะ เทคนิคการจำสูตรใช้ได้จริงในสอบ', '2026-03-26 20:30:00'),
(22, 30, 5, 'ครูชูใจสอน reading ได้ดีมากค่ะ คะแนน ONET อังกฤษขึ้น 15 คะแนน ภายในเดือนเดียว ดีใจมากเลย', '2026-03-28 21:00:00');
